...
import 'package:paskalapps/domain/repositories/ContactnInfoRepository.dart';
...
class _ContactAndInfoState extends State<ContactAndInfo> {
  final CnIRepository dataCnI = CnIRepository();
  ...
  Future<void> getExternalFromFirebase() async {
    List<Map<String, dynamic>> fetchedData = await dataCnI.FetchData();
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(data.isNotEmpty ? data[0]['SosMed'][0] : 'No Data')
                                  ],
                                ),
                                Padding(padding: EdgeInsets.only(top: 15)),
                                Row(
                                  children: [
                                    ...
                                    Padding(padding: EdgeInsets.only(left: 15)),
                                    Text(data.isNotEmpty ? data[0]['SosMed'][1] : 'No Data')
                                  ],
                                )
                              ],
                            )
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Padding(padding: EdgeInsets.only(left: 15)),
                                    Text(data.isNotEmpty ? data[0]['Phone&email'][0] : 'No Data')
                                  ],
                                ),
                                Padding(padding: EdgeInsets.only(top: 15)),
                                Row(
                                  children: [
                                    ...
                                    Icon(Icons.email),
                                    Padding(padding: EdgeInsets.only(left: 15)),
                                    Text(data.isNotEmpty ? data[0]['Phone&email'][1] : 'No Data')
                                  ],
                                )
                              ],
                            ),
