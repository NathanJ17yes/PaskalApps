...
class Remaja extends StatefulWidget {
  Remaja({super.key});

  @override
  State<Remaja> createState() => _RemajaState();
}

class _RemajaState extends State<Remaja> {
              ...
              Container(
                ...
                child:  Row(
                  children: [
                    ...
                    Text(data.isNotEmpty ? data[3]['Id'] : 'No Data',
                  ...
                  Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                           data.isNotEmpty ? data[3]['Judul'] : 'No Data',
                      ...
                      Container(
                        margin: const EdgeInsets.only(top: 5, left: 70),
                        child:  Text(
                          data.isNotEmpty ? data[3]['Ayat_Alkitab'][0] : 'No Data',
                          style: TextStyle(
                              color: Color.fromARGB(255, 53, 52, 52),
                              fontSize: 14),
                        ),
                      ...
                      const SizedBox(
                       ...
                       Padding(
                        ...
                        child: Text(data.isNotEmpty ? data[3]['Deskripsi'] : 'No Data',)
                      ),
                      const SizedBox(
                        height: 40,
                      ),
                       Row(
                        children: [
                          ...
                          Text(data.isNotEmpty ? data[3]['Pendeta'] : 'No Data',)
                        ],
                      ),
                      const SizedBox(
                        height: 15,
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: <Widget>[
                              ...
                              Text(data.isNotEmpty ? data[3]['Tempat'] : 'No Data',)
                            ],
                          )
                        ],
                      ),
                      const SizedBox(
                       ...
                       Row(
                        children: [
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: List.generate(data[3]['Ayat_Alkitab'].length, (index) => Text(data[3]['Ayat_Alkitab'][index]))
                          ),
                        ],
                      ),
                      const SizedBox(
                       ...
                       Row(
                        children: [
                          ...
                          Text(data.isNotEmpty ? data[3]['Waktu'] : 'No Data',)
                        ],
                      ),
                    ],
                  ),
