              ...
              Container(
                ...
                child:  Row(
                  children: [
                    ...
                    Text(data.isNotEmpty ? data[0]['Id'] : 'No Data',
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Container(
                        margin: const EdgeInsets.only(top: 5, left: 70),
                        child: Text(
                          data.isNotEmpty ? data[0]['Ayat_Alkitab'][0] : 'No Data',
                          style: TextStyle(
                              color: Color.fromARGB(255, 53, 52, 52),
                              fontSize: 14),
                        ),
                      ...
                      const SizedBox(
                       ...
                       Padding(
                        ...
                        child: Text(data.isNotEmpty ? data[0]['Deskripsi'] : 'No Data',)
                      ),
                      const SizedBox(
                        height: 40,
                      ),
                       Row(
                        children: [
                          ...
                          Text(data.isNotEmpty ? data[0]['Pendeta'] : 'No Data',)
                        ],
                      ),
                      const SizedBox(
                        height: 15,
                      ...
                      const SizedBox(
                       ...
                       Row(
                        children: [
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: List.generate(data[0]['Ayat_Alkitab'].length, (index) => Text(data[0]['Ayat_Alkitab'][index]))
                          ),
                        ],
                      ),
                      const SizedBox(
