...
class IbadahLembang extends StatefulWidget {
  IbadahLembang({super.key});

  @override
  State<IbadahLembang> createState() => _IbadahLembangState();
}

class _IbadahLembangState extends State<IbadahLembang> {
              ...
              Container(
                ...
                child:  Row(
                  children: [
                    ...
                    Text(data.isNotEmpty ? data[2]['Id'] : 'No Data',
                  ...
                  Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                           data.isNotEmpty ? data[2]['judul'] : 'No Data',
                      ...
                      Container(
                        margin: const EdgeInsets.only(top: 5, left: 70),
                        child:  Text(
                          data.isNotEmpty ? data[2]['Ayat_Alkitab'][0] : 'No Data',
                          style: TextStyle(
                              color: Color.fromARGB(255, 53, 52, 52),
                              fontSize: 14),
                        ),
                      ...
                      const SizedBox(
                       ...
                       Padding(
                        ...
                        child: Text(data.isNotEmpty ? data[2]['Deskripsi'] : 'No Data',)
                      ),
                      const SizedBox(
                        height: 40,
                      ),
                       Row(
                        children: [
                          ...
                          Text(data.isNotEmpty ? data[2]['Pendeta'] : 'No Data',)
                        ],
                      ),
                      const SizedBox(
                        height: 15,
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: <Widget>[
                              ...
                              Text(data.isNotEmpty ? data[2]['Tempat'] : 'No Data',)
                            ],
                          )
                        ],
                      ),
                      const SizedBox(
                       ...
                       Row(
                        children: [
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: List.generate(data[2]['Ayat_Alkitab'].length, (index) => Text(data[2]['Ayat_Alkitab'][index]))
                          ),
                        ],
                      ),
                      const SizedBox(
                       ...
                       Row(
                        children: [
                          ...
                          Text(data.isNotEmpty ? data[2]['Waktu'] : 'No Data',)
                        ],
                      ),
                    ],
                  ),
