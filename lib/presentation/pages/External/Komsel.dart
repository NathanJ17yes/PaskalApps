...
class Komsel extends StatefulWidget {
  const Komsel({super.key});

  @override
  State<Komsel> createState() => _KomselState();
}

class _KomselState extends State<Komsel> {
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                            data.isNotEmpty ? data[2]['Deskripsi'] : 'No Data'),
                      ),
                      const SizedBox(
                        height: 40,
                      ),
